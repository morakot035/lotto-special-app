...
import { apiClient, ThreeDigitSummaryRow } from "../../../services/apiClient";
...
type NoLimit3DResponse = {
  keep: ThreeDigitSummaryRow[];

  send: ThreeDigitSummaryRow[];
};

const EMPTY: NoLimit3DResponse = {
  keep: [],
  send: [],
};
...
export default function Report3DNoLimitPage() {
  const [data, setData] = useState<NoLimit3DResponse>(EMPTY);
  ...
  async function loadData(): Promise<void> {
    try {
      ...
      const res = await apiClient.getThreeDigitNoLimitSummaryReport(token);
